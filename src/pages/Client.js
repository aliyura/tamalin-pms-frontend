            ...
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="full dis_flex center_text">
                                            <div class="profile_img"><img width="180" class="rounded-circle" src={ default_avatar } alt="#" /></div>
                  <div className="profile_contant">
                    <div className="contact_inner">
                      <h3>John Smith</h3>
                      <p><strong>About: </strong>Frontend Developer</p>
                      <ul className="list-unstyled">
                        <li><i className="fa fa-envelope-o" /> : test@gmail.com</li>
                        <li><i className="fa fa-phone" /> : 987 654 3210</li>
                      </ul>
                    </div>
                    <div className="user_progress_bar">
                      <div className="progress_bar">
                        {/* Skill Bars */}
                        <span className="skill" style={{width: '85%'}}>Web Applications <span className="info_valume">85%</span></span>                   
